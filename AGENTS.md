...
- `settings.focus` — `{"labels": [..], "weeks": {"1": [..], ..}}`. Labels replace `focusLabels` everywhere; a week's lines replace that week's `focus` on Today and on the Study tab; anything missing comes from the track. Caps: 6 labels of 1–40 characters, weeks 1–12, 6 lines of ≤ 300 characters each.
